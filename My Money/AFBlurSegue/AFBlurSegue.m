...
-(void)perform {
    ...
    if (NSFoundationVersionNumber <= NSFoundationVersionNumber_iOS_7_1) {
		...
		UIImageView *blurredBackground = [[UIImageView alloc] initWithImage:[background applyLightEffect]];//[[UIImageView alloc]initWithImage:[background applyBlurWithRadius:_blurRadius tintColor:_tintColor saturationDeltaFactor:_saturationDeltaFactor maskImage:nil]];
